...
??? example
    ...
    - Tokens: 9
    - Types: 6 (`the`, `room`, `was`, `white`, `and`, `bed`)
    - TTR: $6/9 = 0.667$
...
??? example
    ...
    - Text A: `received your reply`, `incurred`, `proceeded`, `at your earliest convenience`.
    - Text B: `heard from you`, `gone ahead`, `get the money in`, `soon`.
