...
| :------------ | :---------- | :------------ |
| Rhyme         | C**VC**     | send / mend   |
| Pararhyme     | **C**V**C** | send / sound  |
| Reverse rhyme | **CV**C     | great / graze |
| Alliteration  | **C**VC     | great / grow  |
| Assonance     | C**V**C     | send / bell   |
| Consonance    | CV**C**     | sent / faint  |
