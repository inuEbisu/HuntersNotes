...
或许有读者联想到了傅里叶变换，其原理相通。事实上，如果我们对一个乐音信号进行傅里叶变换，得到的频谱中的共振峰正是泛音列的频率成分；我们可以据此分析得到一些信息，例如辨别它由何种乐器演奏。

## 八度与五度

自然泛音列中的频率成分是基频的整数倍。事实上，像这样频率成整数倍的声音，常常给人耳带来和谐的感觉。以下举两个典型且重要的例子。
...
（对于不熟悉键盘和字母标记法的读者：A4 即为低音 la，A5 为中音 la，A6 为高音 la。）
...
可能有见多识广的读者会觉得似曾相识。事实上，这样的对数感知在很多人类感官中都有体现。例如做过 2023 年全国新高考 I 卷数学第 10 题的读者会知道，人类对音量变化的感知也是对数的。

::fold{title="韦伯-费希纳定律" info}
心理学家韦伯认为，感觉的差别阈限随原来刺激量的变化而变化。

> 以韦伯的实验为例：左手拿着 100g 重物，右手拿着 100g 重物。我们让右手的重物逐渐变重。当右手的重物达到 105g 时，人类能感觉到差异。类似地，如果左手拿的是 10kg 的重物，右手拿的是 10kg + 5g 的重物。同样是左右手相差 5g，此时差异则几乎无法察觉；直到重物增重至 10.5kg 时才被感知到。韦伯首先发现重量的最小可觉差，并发现两重物之间的最小可觉差与标准刺激之比为一常数。
